...
function createMetadata(buffer, referencedAssemblies) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (version < 0 || version > 1000)
            return (0,neverthrow__WEBPACK_IMPORTED_MODULE_0__.err)(new _errors__WEBPACK_IMPORTED_MODULE_2__.MetadataParsingError("Metadata file supplied is not a valid metadata file."));
        // Supported metadata versions: 29, 31, 35, 39 (39 in all features)
        if (![29, 31, 35, 39].includes(version))
...
function readTypeDefinitions(reader, offset, size, imageDefinitions) {
    ...
    while (reader.offset < typesEnd) {
        const typeDef = {
            ...
            // v35 and v39+: no elementTypeIndex field
            elementTypeIndex: metadataVer >= 35 ? 0 : reader.readInt32(),
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("659d8af6bfc51f7789e8")
/******/ 	})();
/******/ 	
