...
/***/ "./node_modules/.pnpm/neverthrow@6.1.0/node_modules/neverthrow/dist/index.es.js":
/*!**************************************************************************************!*\
  !*** ./node_modules/.pnpm/neverthrow@6.1.0/node_modules/neverthrow/dist/index.es.js ***!
  \**************************************************************************************/
...
/* harmony export */ });
/* unused harmony exports Err, Ok, Result, ResultAsync, errAsync, fromPromise, fromSafePromise, fromThrowable, okAsync, safeTry */
...
/* harmony export */ });
/* harmony import */ var neverthrow__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! neverthrow */ "./node_modules/.pnpm/neverthrow@6.1.0/node_modules/neverthrow/dist/index.es.js");
...
function createMetadata(buffer, referencedAssemblies) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let typeDefs = readTypeDefinitions(reader, header.typeDefinitionsOffset, header.typeDefinitionsSize, referencedImageDefs);
            ...
            window.fetch = function (url) {
                ...
                return __awaiter(this, void 0, void 0, function* () {
                    if (url.includes(".data")) {
                        ...
                        const response = yield originalFetch.apply(this, arguments_1);
                        resolve(parseWebData(yield response.clone().arrayBuffer()));
                        return response;
                    }
                    logger.info("5: Not matched %s", url);
                    return originalFetch.apply(this, arguments_1);
                });
            };
        });
    });
...
function parseWebData(data) {
    return new _web_data__WEBPACK_IMPORTED_MODULE_1__.WebData(data, [
        ["data.unity3d", 32],
...
class Runtime {
            ...
            indexedDB.databases().then((databases) => __awaiter(this, void 0, void 0, function* () {
                ...
                request.onsuccess = () => {
                    ...
                    metadataRequest.onsuccess = () => __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (JSON.stringify(this.allReferencedAssemblies.sort()) !==
    ...
    onWebAssemblyInstantiateStreaming(source, importObject) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (source instanceof Promise) {
                ...
                this.logger.error("TypeError: Got an unexpected object type as the first argument to WebAssembly.instantiateStreaming");
    ...
    resolveTableName(asm) {
        return (Object.keys(asm).find((key) => asm[key].constructor.name == "Table") ||
            "Unknown");
    }
...
class ModkitPlugin {
    ...
    call(target, targetMethodOrArgs, args) {
        // @ts-ignore
        const _game = window.unityInstance || game;
        const tableName = this._runtime.tableName ||
        ...
        else if (typeof targetMethodOrArgs === "object" ||
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("9e73cda7ffb4660d46a2")
/******/ 	})();
/******/ 	
